...
VoxCPM2 inference ကို default အားဖြင့် remote Hugging Face Space မှတစ်ဆင့် run သည်။ မိမိ စက်ပေါ်တွင် ပိုမြန်ပြီး rate-limit ကင်းသော inference အတွက် optional local VoxCPM2 server ကို `local-server/` တွင် ပါသည် (အောက်ပါ "Local VoxCPM2 Server" အပိုင်းကို ကြည့်ပါ)။
...
Default အားဖြင့် VoxCPM2 inference ကို remote Hugging Face Space မှတစ်ဆင့် run သည်။ မိမိ စက်ပေါ်တွင် ပိုမြန်ပြီး public Space ၏ rate-limit ကင်းသော inference အတွက် local VoxCPM2 server ကို `local-server/` တွင် ထည့်သွင်းထားသည်။ အသေးစိတ်အတွက် `local-server/README.md` ကို ကြည့်ပါ။
